...
rag = Agent(
    ...
    model=inhouse,
    instructions=(
        "Bạn là trợ lý ảo, chuyên hỗ trợ người dùng với các câu hỏi trắc nghiệm về trả lời dựa trên thông tin trong đoạn văn bản cho trước.\n"
        "Nhiệm vụ của bạn là lập luận và chọn ra đáp án đúng nhất để trả lời câu hỏi của người dùng.\n"
        "Mọi thông tin dùng để trả lời câu hỏi đều chỉ nằm trong đoạn văn bản được cung cấp.\n"
